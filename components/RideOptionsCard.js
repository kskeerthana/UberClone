...
const RideOptionsCard = () => {
  ...
  // console.log('Traveltime Info selector data',travelTimeInformation)
    ...
    <SafeAreaView style={tw`bg-white flex-grow`}>
      <View>
        <TouchableOpacity 
          ...
          style={tw`absolute top-3 left-5 p-3 rounded-full shadow-lg`}>
      ...
      <FlatList
        ...
        renderItem={({item : {id,title,multiplier,image},item}) => (
          <TouchableOpacity 
            onPress={onPress=()=> setSelected(item)}
